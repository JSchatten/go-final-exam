...
type Meeting struct {
	...
	UserID          int64      `json:"user_id" db:"user_id"` // ссылается на telegram_id
	...
	// duration_seconds удалено — отсутствует в БД
}
...
type Transcription struct {
	...
	// language и confidence_avg удалены — отсутствуют в БД
}
...
type Summary struct {
	...
	// model_version удалено — отсутствует в БД
}
